...
import {Injectable, ReflectiveInjector, TRANSLATIONS, TRANSLATIONS_FORMAT } from '@angular/core';
...
// 	// var injector = ReflectiveInjector.resolveAndCreate([HttpClient]);
// var https= injector.get(HttpClient);
...
// 		console.log(lineNum);
// 		console.log(msg);
// 		console.log(stackTraceInfo.browser);
...
// 		errorLog(url,postData).subscribe(response=>{
// 			if(response=="success"){
// 				console.log("congo");
// 			}
// 		})
...
// 	 function errorLog(url, body):Observable<any>{
...
// 		 var injector = ReflectiveInjector.resolveAndCreate([HttpClient]);
// 		 var https= injector.get(HttpClient); 
// 		return this.https.post(url,body,httpOptions).map((Response:any)=>(Response));
// 	}
